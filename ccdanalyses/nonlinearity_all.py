...
def get_txt_info(a_file, data):
    ...
    data["TXT_DIFF_CURRENT_MEDIAN95"] = np.percentile(np.abs(dc[start_ind_p:stop_ind_n]), 95)
    data["TXT_DIFF_CURRENT_MEDIAN97"] = np.percentile(np.abs(dc[start_ind_p:stop_ind_n]), 97)
