...
def get_txt_info(a_file, data):
    ...
    data["TXT_DIFF_CURRENT2_MEAN"] = np.mean(abs_cur*abs_cur)
    data["TXT_DIFF_CURRENT3_MEAN"] = np.mean(abs_cur*abs_cur*abs_cur)
    data["TXT_DIFF_CURRENT4_MEAN"] = np.mean(abs_cur*abs_cur*abs_cur*abs_cur)
