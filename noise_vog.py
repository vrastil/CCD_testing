...
print 'Plotting...'
ph.plot_voltage_all(data, imgs, title, out_dir, suptitle=suptitle)
ph.plot_voltage_ccd(data, imgs, title, out_dir, suptitle=suptitle)
ph.plot_voltage_raft(data, imgs, title, out_dir, suptitle=suptitle)
ph.plot_cor_ccd(aa, imgs[0], title, out_dir, vmin=-0.7, vmax=0.7)
ph.plot_cor_all(aa, imgs[0], title, out_dir, vmin=-0.7, vmax=0.7)
ph.plot_cor_ccd_mean(aa_m, imgs[0], title, out_dir, vmin=-0.7, vmax=0.7)
